  ...
  <div class="min-h-screen bg-gray-50 flex items-center justify-center p-4">
    <div class="bg-white rounded-2xl shadow-xl max-w-md w-full p-8 text-center">
      ...
      <p class="text-gray-600 mb-6">
        Данная платформа предназначена только для корпоративных клиентов. Заказы могут размещать только авторизованные сотрудники компаний-партнеров.
      </p>

      <p class="text-gray-600 text-sm mb-6">
        Для получения доступа, пожалуйста, отправьте Ваш Telegram ID администратору.
      </p>
